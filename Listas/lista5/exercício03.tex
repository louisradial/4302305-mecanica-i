...
\begin{proof}[Resolução]
    ...
    \end{equation*}
    onde \(\vetor{n} = n^\ell \vetor{e}_\ell\), de modo que pelo \nameref{thm:noether} a quantidade \(Q = \sum_{i = 1}^N p_{(i)k} \epsilon^{kab}n_a q_{(i)b}\) é conservada. Pelo \cref{lem:partículas_livres}, obtemos
    \begin{align*}
